...
- **Load this set into your GEO monitoring tool and let it run.** Most tools need 5-7 days of tracking before results are meaningful — don't draw conclusions from a single pass.
